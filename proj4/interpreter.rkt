...
(define interp
  (lambda (stmt myEnv)
       (cond
        ...
        ( else (display "\nI saw something I didn't  understand 1.")))))
...
(define exp
  (lambda (myEnv e)
    (cond
      ...
      ((eqv? (car e) '+) (+ (exp myEnv (cadr e))(exp myEnv (caddr e)))) ; what if the operands were reversed? (Bonus?)
      ...
      (else (display "I saw something I didn't understand 2")))))
